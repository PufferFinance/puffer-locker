...
contract vlPUFFERTest is Test {
    ...
    function test_reLock_afterExpiry() public {
        uint256 initialAmount = 100 ether;
        uint256 initialMultiplier = 1; // 1 month lock
        ...
        assertEq(newUnlockTime, expectedUnlockTime, "Unlock time should be extended");
    }

    function test_reLock_afterExpiry_zeroAmount() public {
        uint256 initialAmount = 100 ether;
        uint256 initialMultiplier = 1; // 1 month lock
